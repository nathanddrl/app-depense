...
// Garde de dépendance de domain-aid (archi ch.1.4 / DA4) : un domaine peut
...
// répertoire d'où ESLint est lancé (miroir de la garde domain-expense).
export default [
  ...base,
  {
    files: ["**/*.ts"],
      ...
      "no-restricted-imports": [
        "error",
        {
          patterns: [
            ...
            {
              group: ["@app/domain-expense", "@app/domain-settlement", "@app/domain-recurrence"],
              message:
