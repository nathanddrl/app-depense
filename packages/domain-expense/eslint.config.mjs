...
// Garde de dépendance de domain-expense (archi ch.1.4 / DA4) : un domaine peut
...
// répertoire d'où ESLint est lancé (miroir de la garde calc-engine).
export default [
  ...base,
  {
    files: ["**/*.ts"],
      ...
      "no-restricted-imports": [
        "error",
        {
          patterns: [
            ...
            {
              group: ["@app/domain-aid", "@app/domain-settlement", "@app/domain-recurrence"],
              message:
